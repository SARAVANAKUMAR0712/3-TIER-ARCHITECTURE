...
vi Sk.pem
chmod 400  Sk.pem
ssh -i  Sk.pem ec2-user@10.0.4.162
```
...
sudo dnf install -y mysql-community-server --nogpgche
mysql -h Skdb-1.c7gw60cigbja.ap-southeast-2.rds.amazonaws.com -P 3306 -u admin -p
```
